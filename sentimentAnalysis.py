...
def graphStuff():
    ...
    plt.savefig("/Users/josephduppstadt/Downloads/SentimentScraping/barchart.png")
    pdf.image('/Users/josephduppstadt/Downloads/SentimentScraping/barchart.png')
...
file_reviews = open("/Users/josephduppstadt/Downloads/SentimentScraping/finalOutput.txt", "r")
...
for i in range(n):
    for j in range(0, n - i - 1):
        if website_list[j] > website_list[j + 1]:
            website_list[j], website_list[j + 1] = website_list[j + 1], website_list[j]
            reviews_list[j], reviews_list[j + 1] = reviews_list[j + 1], reviews_list[j]
